        !COMPILER-GENERATED INTERFACE MODULE: Wed Jun 18 20:03:58 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE WATER_MIXING_ITER_EI_KIN_ANAL_IDEAL_OPT2__genmod
          INTERFACE 
            SUBROUTINE WATER_MIXING_ITER_EI_KIN_ANAL_IDEAL_OPT2(THIS,   &
     ...
     &          NEWTON_EFI_RK_KIN_AQ_ANAL_IDEAL
            ...
            END SUBROUTINE WATER_MIXING_ITER_EI_KIN_ANAL_IDEAL_OPT2
          END INTERFACE 
        END MODULE WATER_MIXING_ITER_EI_KIN_ANAL_IDEAL_OPT2__genmod
