        ...
        MODULE COMPUTE_CONC_SURF_IDEAL_NEWTON__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_CONC_SURF_IDEAL_NEWTON(THIS,CONC_CATS,   &
     ...
     &          LU_LIN_SYST
            ...
            END SUBROUTINE COMPUTE_CONC_SURF_IDEAL_NEWTON
          END INTERFACE 
        END MODULE COMPUTE_CONC_SURF_IDEAL_NEWTON__genmod
