        !COMPILER-GENERATED INTERFACE MODULE: Tue Jun 17 18:24:38 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE WATER_MIXING_ITER_EI_EQ_KIN_ANAL_IDEAL_OPT2_LUMP__genmod
          INTERFACE 
            SUBROUTINE WATER_MIXING_ITER_EI_EQ_KIN_ANAL_IDEAL_OPT2_LUMP(&
     ...
     &WATER_MIXING_ITER_EI_EQ_KIN_ANAL_IDEAL_OPT2_LUMP
          END INTERFACE 
        END MODULE                                                      &
     &WATER_MIXING_ITER_EI_EQ_KIN_ANAL_IDEAL_OPT2_LUMP__genmod
