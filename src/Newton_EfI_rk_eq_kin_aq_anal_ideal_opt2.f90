...
!     real(kind=8), allocatable :: u_rk_tilde(:) !> reaction part of component concentrations after mixing
...
!         u_rk_tilde=Delta_t*matmul(this%solid_chemistry%reactive_zone%U_SkT_prod,rk_tilde)
!     !> Newton loop
!         do 
...
!                 print *, "Too many iterations in subroutine Newton_EfI_rk_eq_kin_aq_anal_ideal_opt2"
!                 exit
!             end if
...
!                 exit
!             else
!                 call this%compute_dfk_dc1_aq_EfI_ideal(conc_nc(n_p+1:n_nc),drk_dc,Delta_t,mix_ratio_Rk,dfk_dc1) !> computes Jacobian of Newton resiudal
...
!         end do
! !> Post-process
!     deallocate(fk,dfk_dc1,Delta_c1,drk_dc,rk,u_tilde,u_rk_tilde,c2nc)
! end subroutine