...
subroutine read_PHREEQC_DB_opc1(this,filename)
    ...
    num_react_zones,aq_sp_ind,elem_name_len,niter,num_elem,unit
    ...
    unit=5 !> we assign file unit number
    ...
    !>                    do i=1,num_mins
    !>                        backspace(unit)
    !>                        read(unit,*) reactive_zone%ind_non_flow_species(i)%name, target_SI, solid_chem_init%concentrations(i)
