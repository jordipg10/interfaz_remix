...
subroutine water_mixing_iter_EE_kin_ideal_lump(this,c1_old,c_tilde,Delta_t,theta,conc_nc)
    use aqueous_chemistry_m, only: aqueous_chemistry_c,  inf_norm_vec_real, reaction_iteration_EE_kin_lump, &
...
!> Aqueous concentrations
    ...
    call this%reaction_iteration_EE_kin_lump(Delta_t,conc_react) !> we compute chemical part of concentrations
