!> \file compute_trans_mat_diff.f90
!> \brief Computes the transition (stiffness) matrix T for stationary diffusion.
!> \details
!> Assembles the tridiagonal, symmetric, negative semi-definite matrix
!> \f$ T \f$ from the finite-volume discretisation of \f$ -\nabla \cdot (D \nabla c) = 0 \f$.
!>
!> \author Jordi
!> \date Unknown
!> \ingroup discretization
!> \see diffusion_m, compute_trans_mat_diff_trans
