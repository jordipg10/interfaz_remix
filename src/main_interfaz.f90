program main_interfaz
    ...
    if (opc_u_tilde.eq.0) then
        write(*,*) "De acuerdo. Vamos a calcular las concentraciones después de resolver el transporte conservativo para el primer&
            paso de tiempo."
        write(*,*) "Nombre del archivo donde quieres que escriba estas concentraciones? (este archivo estará en el mismo &
            directorio)."
        read(*,*) file_u_tilde
        ...
        !> we read transport data, BCs and discretisations
            ...
            !write(*,*) "Elegir m�todo de integraci�n temporal para las reacciones qu�micas (1: Euler explicito, & 
    ...
    write(*,*) "Procedemos al bucle de mezcla reactiva. Tendrás que actualizar el archivo con las concentraciones después del &
        transporte conservativo en cada iteración."
    do
