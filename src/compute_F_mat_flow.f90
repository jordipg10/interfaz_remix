!> \file compute_F_mat_flow.f90
!> \brief Computes the storage (diagonal) matrix F for the flow equation.
!> \details
!> Builds the diagonal matrix \f$ F_{ii} = S_i \f$ (storativity)
!> arising from the finite-volume discretisation of the transient
!> groundwater flow equation \f$ F\,dh/dt = T\,h + g \f$.
!>
!> \author Jordi
!> \date Unknown
!> \ingroup discretization
!> \see flow_transient_m, compute_F_mat_diff
