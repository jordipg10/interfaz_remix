            ...
            do
                ...
                do !while (str_trim(1:1)/='')
                    ...
                    if (index(str_trim,'#')==1 .or. index(str_trim,'#')==2) then
                        ...
                        backspace(61)
                        read(61,*) str, this%gas_phase%gases(gas_counter)%crit_temp
                    else if (index(str_trim,'P_c')==3) then
                        backspace(61)
                        read(61,*) str, this%gas_phase%gases(gas_counter)%crit_press
                    else if (index(str_trim,'Omega')==3) then
                        backspace(61)
                        read(61,*) str, this%gas_phase%gases(gas_counter)%acentric_fact
                    else if (str_trim(1:1)/='') then
                        backspace(61)
                        exit
                    else
