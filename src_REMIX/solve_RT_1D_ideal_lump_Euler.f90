    ...
    !end do
        ...
        do k=1,this%transport%time_discr%Num_time
            ...
            do i=1,this%chemistry%num_target_waters_dom
                call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%update_conc_old() !> 
                call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%solid_chemistry%update_conc_old() !> 
                call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%update_rk_old()
                call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%solid_chemistry%update_rk_old()
            end do
            ...
            do i=1,num_non_can_vec
                ...
                !else
                    ...
                    !    if (j==
                    !    mix_waters(j)=target_waters_new(this%transport%mixing_waters_indices%cols(i)%col_1(&
                    !    mix_ind+j-1))
                    !mix_waters=target_waters_new(this%transport%mixing_waters_indices_dom%cols(ind_non_can_vec(i))%col_1(mix_ind:this%transport%mixing_waters_indices_dom%cols(ind_non_can_vec(i))%dim-2))
                    ...
                    !!> chapuza
                    !target_waters_new(this%transport%mixing_waters_indices_dom%cols(ind_non_can_vec(i))%col_1(mix_ind:this%transport%mixing_waters_indices_dom%cols(ind_non_can_vec(i))%dim-2))=&
                    !    mix_waters
                    !call target_waters_new(this%chemistry%dom_tar_wat_indices(ind_non_can_vec(i)))%solid_chemistry%modify_mix_ratios_rk(&
                    ...
                    !> We solve reactive mixing iteration
                     call p_solver(target_waters_new(this%chemistry%dom_tar_wat_indices(i)),target_waters_old_old(&
                    ...
                    if (this%chemistry%target_waters(this%chemistry%dom_tar_wat_indices(i)&
                        ...
                        this%chemistry%target_waters(this%chemistry%dom_tar_wat_indices(i))%indices_rk%num_cols>0)&
                            then
                        call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%compute_Re_mean_rk_lump(&
                        ...
                        call target_waters_new(this%chemistry%dom_tar_wat_indices(i))%compute_Re_mean_lump(&
                            c_tilde(n_p+1:n_p+n_nc_aq_2),Delta_t,&
                            theta) !> chapuza
                    end if
                    ...
                    if (associated(target_waters_new(this%chemistry%dom_tar_wat_indices(&
                        i))%solid_chemistry%mineral_zone)) &
                        then
                    !> We compute mass volumetric fractions of minerals from mass balance equation
                        call target_waters_new(this%chemistry%dom_tar_wat_indices(&
                    ...
                    if (associated(target_waters_new(this%chemistry%dom_tar_wat_indices(i))%gas_chemistry)) then
...
!> We set the new target waters to the chemistry object
    this%chemistry%target_waters=target_waters_new
    close(unit)
end select
end subroutine