...
!        !print *, this%rk
!        !print *, drk_dc
!        fk=matmul(this%solid_chemistry%reactive_zone%speciation_alg%comp_mat,this%concentrations(1:n_nc))-u_tilde-(Delta_t/porosity)*matmul(this%U_SkT_prod,this%rk) !> Newton residual
...
!                !if (niter>this%solid_chemistry%reactive_zone%CV_params%niter_max/2 .and. eta_new>=eta_old) then
