...
!> Arguments
    ...
    real(kind=8), intent(in) :: theta !> time weighting factor (=1)
    ...
    !> Initial guess aquoeus primary concentrations
        ...
        do
            ...
            !> We apply Newton method to compute aqueous concentrations
                call this%Newton_EfI_rk_eq_kin_aq_anal_ideal(u_tilde,u_rk_tilde,mix_ratio_Rk,Delta_t_bis,conc_nc,niter,CV_flag)
